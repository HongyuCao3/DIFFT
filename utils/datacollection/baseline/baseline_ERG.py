...
sys.path.append('/home/local/ASURITE/ngong6/code/MMFT')
import torch
...
def init_param():
    ...
    parser.add_argument('--file-name', type=str, default='spectf',
        help='data name')
    ...
    parser.add_argument('--episodes', type=int, default=1, help=
...
def model_train(param, id):
    ...
    while episode < EPISODES:
        ...
        Dg_.columns = Dg_.columns.astype(str)
        ...
        if new_per > best_per:
            ...
            D_OPT = Dg_.copy()
        episode += 1
    D_original.columns = D_original.columns.astype(str)
...
if __name__ == '__main__':
    ...
    for name in [
        ...
        # 'ionosphere',
        #                                                            'lymphography',
        'messidor_features', 'openml_620', 'ionosphere',
                                                                   'german_credit', 'spam_base', 'spectf', 'svmguide3',
                                                                   
                                                                   'openml_586',
                                                                   'openml_589', 'openml_607', 'openml_616',
                                                                   'openml_618',
                                                                   'openml_637','ap_omentum_ovary']:
